...
|   1.7   | 08/04/2026 | Castro Alejos, Julio Daniel      | Se desarrollan los prototipos interactivos de laaplicación iOS (4.5.2) y Android (4.5.1) con flujos de navegación completos. Se elabora el Web Applications Prototyping (4.7) con pantallas y flujos de usuario de la aplicación web.                                                                                                                                                                                                                                                                             |
