...
|   2.5   | 15/06/2026 | Sanchez Guevara, Ivan Fernando   | Se documentan los Coding Standard & Code Conventions (6.2.1.1). Se registran las entrevistas a proveedores (6.3.2) y se inicia la documentación de la auditoría realizada, incluyendo la información del grupo auditado (6.4.1.1) y el cronograma de auditoría realizada (6.4.1.2).                                                                                                                                                                                                                              |
|   2.6   | 15/06/2026 | Castro Alejos, Julio Daniel      | Se documenta la sección de Code Quality & Code Security (6.2.1.2). Se formulan las Experiment-Ready Questions (8.1.3) y se definen las Domain Business Metrics (8.2.2) como base para la medición del experimento.                                                                                                                                                                                                                                                                                                 |
|   2.7   | 15/06/2026 | Guerra Perez, José Jahaziel     | Se documentan los Reviews (6.2.2). Se registran las entrevistas a restaurantes (6.3.2) y se organiza el material inicial de experimentación mediante Raw Material: Assumptions, Knowledge Gaps, Ideas, Claims (8.1.2).                                                                                                                                                                                                                                                                                              |
|   2.8   | 15/06/2026 | Shapiama Rivera, Gabriela Nicole | Se elabora el Diseño de Entrevistas (6.3.1). Se documentan las herramientas y prácticas de operación mediante Tools and Practices (7.4.1), así como los componentes de Monitoring Pipeline (7.4.2), Alerting Pipeline (7.4.3) y Notification Pipeline (7.4.4).                                                                                                                                                                                                                                                   |
|   2.9   | 15/06/2026 | Chavez Uribe, Ario               | Se registran las entrevistas realizadas a ambos segmentos (6.3.2). Se desarrollan las evaluaciones según heurísticas (6.3.3) y se inicia la documentación de la auditoría recibida con la información del grupo auditor (6.4.2.1) y el cronograma de auditoría recibida (6.4.2.2).                                                                                                                                                                                                                             |
|   3.0   | 16/06/2026 | Sanchez Guevara, Ivan Fernando   | Se completa el contenido de la auditoría realizada (6.4.1.3). Se documentan las Conditions (8.2.4) del diseño experimental y se actualizan las Conclusiones y la Bibliografía del informe conforme a los avances de AV2.                                                                                                                                                                                                                                                                                          |
|   3.1   | 16/06/2026 | Chavez Uribe, Ario               | Se completa el contenido de la auditoría recibida (6.4.2.3) y el resumen de modificaciones para subsanar hallazgos (6.4.2.4). Se documentan las Scale Calculations and Decisions (8.2.5) y se actualizan los Anexos del informe.                                                                                                                                                                                                                                                                                    |
|   3.2   | 16/06/2026 | Shapiama Rivera, Gabriela Nicole | Se redacta el As-Is Summary (8.1.1). Se organiza el Question Backlog (8.1.4), se desarrollan las Experiment Cards (8.1.5), se formulan las Hypotheses (8.2.1) y se documenta Data Analytics: Goals, KPIs and Metrics Selection (8.2.7).                                                                                                                                                                                                                                                                              |
|   3.3   | 16/06/2026 | Castro Alejos, Julio Daniel      | Se desarrollan las Measures (8.2.3) y se seleccionan los métodos de validación mediante Methods Selection (8.2.6). Además, se documentan los Project Collaboration Insights para evidenciar la coordinación y participación del equipo durante AV2.                                                                                                                                                                                                                                                             |
|   3.4   | 16/06/2026 | Guerra Perez, José Jahaziel     | Se documenta el Web and Mobile Tracking Plan (8.2.8). Se elaboran las To-Be User Stories (8.3.1) y se actualiza el To-Be Product Backlog (8.3.2), alineando las historias y prioridades con los resultados esperados de la experimentación.                                                                                                                                                                                                                                                                         |
|   3.5   | 20/06/2026 | Castro Alejos, Julio Daniel      | Se documenta la evidencia de implementación de la Native-Mobile Application To-Be (8.3.3.4). Se redactan los Report Collaboration Insights, documentando la colaboración del equipo durante el AV2. Se elabora la Matriz de Evaluación Ética y de Impacto del proyecto.                                                                                                                                                                                                                                            |
|   3.6   | 22/06/2026 | Guerra Perez, José Jahaziel     | Se documenta la evidencia de implementación del Frontend-Web Application To-Be (8.3.3.3). Se redacta el Analysis and Interpretation of Results (8.4.1). Se registran 2 entrevistas adicionales realizadas a restaurantes (6.3.2).                                                                                                                                                                                                                                                                                    |
|   3.7   | 25/06/2026 | Shapiama Rivera, Gabriela Nicole | Se elabora el Diseño de Entrevistas (8.3.4.1). Se revisan y validan el To-Be Product Backlog (8.3.2) y las To-Be User Stories (8.3.1). Se documentan los To-Be Sprint Backlogs (8.3.3.1) y la evidencia de implementación del RESTful API y/o Serverless Backend To-Be (8.3.3.5). Se elaboran los Shareback Session Artifacts: Learning Workflow (8.5.1).                                                                                                                                                          |
|   3.8   | 27/06/2026 | Chavez Uribe, Ario               | Se documentan los Team Collaboration Insights (8.3.3.6). Se corrigen y actualizan los Anexos del informe. Se registran 2 entrevistas adicionales, una por cada segmento (6.3.2).                                                                                                                                                                                                                                                                                                                                    |
|   3.9   | 30/06/2026 | Sanchez Guevara, Ivan Fernando   | Se registran 2 entrevistas adicionales realizadas a proveedores (6.3.2). Se produce el About-the-Product Intro Video (8.6.1) y el Video App Validation. Se redactan las Conclusiones y recomendaciones del informe. Se documenta la evidencia de implementación de la Landing Page To-Be (8.3.3.2). Se actualiza el Re-scored and Re-prioritized Question Backlog (8.4.2).                                                                                                                                        |
...
| :--- | :--- | :--- |
| **4.c.1 Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software** | **Julio Castro Alejos** <br>*AV1* <br>Ejerció responsabilidad profesional al documentar las dinámicas del equipo (*Team Collaboration Insights*) y asegurar la integridad de la información mediante el diseño de diagramas de bases de datos relacionales/no relacionales.<br>*TB1* <br>Ejerció responsabilidad profesional al documentar y configurar los procesos de integración continua, definiendo herramientas y prácticas del equipo. Asimismo, garantizó la transparencia del proyecto al agregar los links de repositorios individuales de control de versiones con Git para todos los productos de software del equipo.<br>*AV2* <br>Ejerció responsabilidad profesional al documentar las métricas de dominio del negocio (*Domain Business Metrics*), las mediciones del sistema (*Measures*) y las preguntas orientadas a experimentos (*Experiment-Ready Questions*), garantizando la trazabilidad y rigor técnico del proceso de validación. Asimismo, veló por la calidad y seguridad del código (*Code Quality & Code Security*) y mantuvo la transparencia del trabajo colaborativo mediante el registro de *Project Collaboration Insights*.<br>*TB2* <br>Ejerció responsabilidad profesional al documentar las dinámicas de colaboración del equipo mediante el *Report Collaboration Insights*, garantizando la transparencia del trabajo colaborativo. Asimismo, evidenció compromiso ético al elaborar la *Matriz de Evaluación Ética y de Impacto*, sistematizando criterios de responsabilidad profesional para la evaluación del proyecto.<br><br>**Ario Chavez Uribe** <br>*AV1* <br>Garantizó la transparencia y trazabilidad del proyecto manteniendo el *Registro de Versiones del Informe* y estableciendo los *Web Style Guidelines* para asegurar estándares profesionales de desarrollo.<br>*TB1* <br>Reforzó la trazabilidad y completitud del informe al actualizar el avance de *Conclusiones*, *Bibliografía* y *Anexos*, asegurando que el documento refleje con rigor y honestidad el estado real del proyecto.<br>*AV2* <br>Promovió la ética profesional al documentar rigurosamente los procesos de auditoría recibida (*Información del grupo auditor*, *Cronograma*, *Contenido* y *Resumen de modificaciones para subsanar hallazgos*), asegurando transparencia y trazabilidad frente a observaciones externas. Además, garantizó estándares de calidad al documentar las evaluaciones según heurísticas y los Anexos del informe.<br>*TB2* <br>Reforzó la transparencia del proyecto al documentar las *Team Collaboration Insights* y al corregir y actualizar los *Anexos* del informe, asegurando la integridad y honestidad del documento final. Asimismo, ejerció responsabilidad profesional al registrar fielmente las entrevistas realizadas a dos segmentos distintos de usuarios (uno de cada segmento), documentando los hallazgos con rigor técnico.<br><br>**Fernando Sanchez Guevara** <br>*AV1* <br>Promovió la consistencia técnica y las buenas prácticas profesionales al estandarizar los lineamientos visuales (*iOS & Android Mobile Style Guidelines*) y formalizar la presentación del proyecto (*Carátula*).<br>*TB1* <br>Ejerció responsabilidad profesional al formalizar el modelo de negocio del producto mediante la documentación del *Acuerdo de Servicio SaaS*, estableciendo compromisos claros con los usuarios y considerando las implicancias legales y éticas del modelo de distribución de software.<br>*AV2* <br>Demostró responsabilidad profesional al documentar los estándares y convenciones de código (*Coding Standard & Code Conventions*), estableciendo lineamientos técnicos claros para el equipo. Asimismo, ejerció ética en la gestión documental al elaborar las *Conclusiones* y la *Bibliografía*, asegurando la integridad y honestidad del informe final.<br>*TB2* <br>Ejerció ética profesional al documentar fielmente el registro de entrevistas a proveedores, asegurando la honestidad de los hallazgos recopilados. Asimismo, mantuvo la integridad y rigor del informe final al redactar las *Conclusiones y recomendaciones* del proyecto.<br><br>**Jahaziel Guerra** <br>*AV1* <br>Evidenció ética profesional al documentar rigurosamente la API RESTful y elaborar los diagramas de arquitectura de contenedores, garantizando la mantenibilidad y transparencia del sistema para futuros desarrolladores.<br>*TB1* <br>Reforzó la ética profesional al corregir la documentación del *RESTful API*, asegurando que cada endpoint incluya descripción y ejemplos completos para todos los tipos de request, garantizando transparencia técnica y facilidad de integración para otros desarrolladores.<br>*AV2* <br>Evidenció responsabilidad ética y profesional al llevar a cabo el registro de entrevistas con usuarios del segmento restaurantes, documentando fielmente los hallazgos para sustentar decisiones basadas en evidencia. Contribuyó además a la transparencia del proyecto mediante la documentación de *Reviews* del sprint y la elaboración de los *To-Be User Stories* y el *To-Be Product Backlog*.<br>*TB2* <br>Evidenció responsabilidad ética al documentar fielmente el registro de entrevistas con el segmento de restaurantes, garantizando la trazabilidad de los hallazgos. Asimismo, contribuyó a la mantenibilidad y transparencia del sistema mediante la implementación documentada de la aplicación *Frontend-Web (To-Be)*.<br><br>**Gabriela Shapiama** <br>*AV1* <br>Demostró liderazgo ético y profesional al gestionar la propiedad intelectual en GitHub (migración y creación de la organización), distribuir tareas de manera equitativa en Jira y asegurar la calidad del entregable final mediante la revisión del informe y la corrección del backend.<br>*TB1* <br>Demostró responsabilidad profesional al corregir errores en el módulo de *Ventas* del backend, subsanar inconsistencias en el índice del informe, agregar el nombre del curso faltante en la carátula y velar por la correcta nomenclatura de los entregables, asegurando el cumplimiento de los estándares definidos por el equipo.<br>*AV2* <br>Demostró liderazgo ético al gestionar y documentar los componentes del pipeline de monitoreo, alertas y notificaciones (*Monitoring*, *Alerting* y *Notification Pipeline Components*), asegurando la integridad operativa del sistema. Asimismo, garantizó la transparencia del proceso de validación al elaborar el diseño de entrevistas, el *As-Is Summary*, el *Question Backlog* y las *Experiment Cards*, documentando con rigor el estado real del proyecto.<br>*TB2* <br>Demostró liderazgo ético y profesional al revisar y validar el *To-Be Product Backlog* y las *To-Be User Stories*, asegurando la calidad, coherencia y cumplimiento de los estándares definidos por el equipo. Asimismo, documentó los *Shareback Session Artifacts (Learning Workflow)*, reforzando la transparencia del proceso de aprendizaje colectivo del equipo. | *AV1* <br>El equipo evidenció un alto grado de profesionalismo al establecer y respetar estándares claros de diseño arquitectónico y de interfaz. Se adoptaron herramientas estándar de la industria (como Jira y GitHub) para garantizar un trabajo colaborativo ético, donde la distribución de tareas fue transparente. Asimismo, la rigurosa documentación de APIs, bases de datos y registros de versiones demuestra un compromiso con la mantenibilidad, la trazabilidad y la responsabilidad técnica inherente a la ingeniería de software.<br><br>*TB1* <br>El equipo reforzó su compromiso ético y profesional al corregir y completar aspectos críticos del informe y los productos de software, asegurando la integridad documental y técnica del entregable. La corrección de módulos del backend, la actualización de registros bibliográficos y la mejora de la documentación del API demuestran una actitud responsable frente a los errores detectados y un compromiso genuino con la calidad del trabajo entregado.<br><br>*AV2* <br>El equipo reforzó su compromiso ético y profesional al documentar con rigor los procesos de validación, auditoría y calidad del software. La elaboración de estándares de código, la documentación de hallazgos de entrevistas y la actualización de backlog evidencian una actitud responsable hacia la mantenibilidad y la transparencia técnica. La corrección activa frente a observaciones externas (auditoría recibida) y la sistematización de métricas y mediciones demuestran un compromiso genuino con la integridad del trabajo entregado y con los estándares profesionales de la ingeniería de software.<br><br>*TB2* <br>El equipo consolidó su compromiso ético y profesional al documentar con rigor las dinámicas de colaboración, actualizar y corregir los anexos del informe, y registrar fielmente los hallazgos de las entrevistas realizadas a los distintos segmentos de usuarios (restaurantes y proveedores). La revisión y validación de los backlogs y user stories, así como la elaboración de la Matriz de Evaluación Ética y de Impacto, evidencian una actitud responsable y madura frente a la calidad, la transparencia y la integridad del trabajo en equipo. |
| **4.c.2 Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales** | **Julio Castro Alejos** <br>*AV1* <br>Emitió juicios informados orientados a la experiencia del usuario final mediante el prototipado e implementación de aplicaciones (iOS, Android, Web Frontend) y evaluó el impacto comunicacional del producto mediante la creación del *Video About-the-Product*.<br>*TB1* <br>Tomó decisiones informadas sobre la estrategia de entrega continua al documentar los componentes del pipeline de *Build & Test Suite*, así como las herramientas y etapas del proceso de *Continuous Delivery*, evaluando su impacto en la eficiencia del ciclo de entrega y en la calidad del producto para los usuarios finales.<br>*AV2* <br>Emitió juicios informados al seleccionar métodos de investigación (*Methods Selection*) y definir las preguntas de experimento (*Experiment-Ready Questions*), evaluando cómo estas decisiones impactan la validación del producto a nivel de mercado y usuarios. Contribuyó asimismo a la evaluación del impacto económico del negocio mediante la documentación de *Domain Business Metrics* y *Measures*.<br>*TB2* <br>Emitió juicios técnicos informados al implementar la aplicación nativa móvil (*To-Be Native-Mobile Application*), evaluando su impacto en la experiencia del usuario final en dispositivos móviles. Asimismo, contribuyó a la evaluación del impacto ético y social del proyecto mediante la elaboración de la *Matriz de Evaluación Ética y de Impacto*, sistematizando criterios para la toma de decisiones informadas.<br><br>**Ario Chavez Uribe** <br>*AV1* <br>Implementó la *Landing Page* e integró los anexos considerando el impacto económico y de mercado, garantizando que el valor de la solución sea comunicado de manera efectiva al público objetivo global.<br>*TB1* <br>Emitió juicios técnicos informados al desarrollar los *Core Entities Unit Tests*, evaluando la solidez de las entidades centrales del sistema y asegurando que el comportamiento del software sea predecible y confiable en todos los contextos de uso.<br>*AV2* <br>Tomó decisiones informadas sobre la escala del sistema al documentar los *Scale Calculations and Decisions*, evaluando el impacto técnico y económico del crecimiento del producto. Su participación en la auditoría recibida y en la evaluación heurística le permitió emitir juicios fundamentados sobre la experiencia de usuario y las mejoras necesarias para ampliar el impacto social de la solución.<br>*TB2* <br>Tomó decisiones informadas sobre la calidad de la evidencia recopilada al registrar entrevistas con usuarios de distintos segmentos, evaluando cómo estos hallazgos impactan las decisiones de producto y la comprensión de las necesidades del mercado.<br><br>**Fernando Sanchez Guevara** <br>*AV1* <br>Consolidó el impacto del proyecto mediante la redacción de las *Conclusiones* y el diseño inicial (*Landing Page Mock-up*), evaluando cómo la solución final resuelve el problema social/económico planteado.<br>*TB1* <br>Emitió juicios fundamentados sobre el comportamiento esperado del sistema al implementar los *Core Behavior-Driven Development* tests, asegurando que las funcionalidades respondan efectivamente a los escenarios reales de los usuarios y generen el impacto social previsto.<br>*AV2* <br>Evaluó el impacto global del proyecto mediante la redacción de las *Conclusiones*, analizando cómo la solución responde a los problemas sociales y económicos identificados. Documentó las *Conditions* del experimento, emitiendo juicios informados sobre los factores del entorno que condicionan el éxito de la solución en diferentes contextos de uso.<br>*TB2* <br>Evaluó el impacto comunicacional y económico del producto mediante la elaboración del video introductorio (*About-the-Product Intro Video*) y del *Video App Validation*, considerando cómo estas piezas comunican el valor de la solución al mercado objetivo. Asimismo, emitió juicios informados sobre el impacto de mercado al implementar la evidencia del *To-Be Landing Page* y al re-priorizar el *Question Backlog* en función de los hallazgos obtenidos. Consolidó además el impacto global del proyecto mediante la redacción de las *Conclusiones y recomendaciones* finales, evaluando cómo la solución responde a los problemas identificados.<br><br>**Jahaziel Guerra** <br>*AV1* <br>Tomó decisiones estratégicas utilizando el *Impact Mapping* y el levantamiento de *User Stories* para asegurar que las funcionalidades del *Sprint/Product Backlog* generen un impacto real y positivo en el flujo de negocio y en los usuarios finales.<br>*TB1* <br>Evaluó el impacto de la integración entre módulos del sistema mediante los *Core Integration Tests* y tomó decisiones informadas sobre la estrategia de despliegue en producción al definir las herramientas y componentes del pipeline de *Continuous Deployment*, considerando la confiabilidad y disponibilidad global del sistema.<br>*AV2* <br>Tomó decisiones estratégicas informadas al elaborar los *To-Be User Stories* y el *To-Be Product Backlog*, priorizando funcionalidades de alto impacto para los usuarios finales. Evaluó además el impacto del sistema en los flujos de negocio de restaurantes mediante el registro de entrevistas y la documentación del *Web and Mobile Tracking Plan*, asegurando que las decisiones de producto respondan a necesidades reales del mercado.<br>*TB2* <br>Emitió juicios informados al analizar e interpretar los resultados del proyecto (*Analysis and Interpretation of Results*), evaluando su impacto en las decisiones de negocio y en la dirección del producto. Asimismo, tomó decisiones estratégicas al registrar entrevistas con el segmento de restaurantes, evaluando el impacto de la solución en los flujos de negocio de este segmento del mercado.<br><br>**Gabriela Shapiama** <br>*AV1* <br>Realizó juicios técnicos informados al implementar el backend utilizando arquitecturas *Serverless* y *RESTful API*, considerando factores económicos (reducción de costos de infraestructura) y de impacto global (alta disponibilidad y escalabilidad).<br>*TB1* <br>Emitió juicios informados sobre la calidad integral del sistema al desarrollar los *Core System Tests* y reestructurar los índices del capítulo de arquitectura, asegurando coherencia documental y que la solución implementada responda a criterios de calidad, escalabilidad y sostenibilidad definidos para el proyecto.<br>*AV2* <br>Emitió juicios informados sobre el impacto operativo y de negocio al definir los *Goals, KPIs and Metrics Selection* del sistema de analítica de datos, considerando la sostenibilidad y escalabilidad de la solución. La documentación de los componentes del pipeline de monitoreo y el *As-Is Summary* permitieron evaluar el estado actual del sistema y orientar las mejoras hacia un mayor impacto global y confiabilidad del producto.<br>*TB2* <br>Tomó decisiones informadas sobre la priorización del trabajo del equipo al elaborar los *To-Be Sprint Backlogs*, considerando el impacto de cada funcionalidad en el valor entregado al usuario final. Asimismo, emitió juicios técnicos informados al implementar la evidencia del *RESTful API y/o Backend Serverless*, evaluando el impacto en la escalabilidad, disponibilidad y costos operativos del sistema. Contribuyó también al *Diseño de Entrevistas*, orientando la recolección de evidencia para la validación del producto en el mercado. | *AV1* <br>El equipo demostró capacidad para emitir juicios informados al alinear continuamente las decisiones tecnológicas con las necesidades del mercado y del usuario. La aplicación de metodologías como *Impact Mapping* permitió priorizar características de alto valor social y de negocio. Además, la elección de servicios en la nube (*Serverless*) y el desarrollo multiplataforma (Web y Móvil) evidencian una consideración directa sobre la escalabilidad económica, la eficiencia de recursos y el impacto global de la solución implementada.<br><br>*TB1* <br>El equipo consolidó su capacidad de juicio técnico e informado al implementar pruebas de distintos niveles (unitarias, de integración, de comportamiento y de sistema) y al definir pipelines de integración y despliegue continuo. Estas decisiones reflejan una evaluación consciente del impacto que la calidad del software tiene sobre los usuarios finales y sobre la sostenibilidad operativa del producto a escala global.<br><br>*AV2* <br>El equipo consolidó su capacidad de emitir juicios técnicos e informados al definir métricas de negocio, condiciones de experimento, hipótesis y planes de seguimiento web y móvil. Estas decisiones reflejan una evaluación consciente del impacto que la calidad y escalabilidad del software tienen sobre los usuarios finales y sobre la sostenibilidad operativa del producto. La incorporación de criterios de monitoreo continuo, analítica de datos y validación basada en entrevistas evidencia una consideración directa sobre el impacto económico, social y global de la solución implementada.<br><br>*TB2* <br>El equipo reforzó su capacidad de emitir juicios técnicos e informados al implementar evidencias funcionales del producto (aplicación móvil, frontend web, backend serverless, landing page) y al analizar e interpretar los resultados obtenidos durante el sprint. La elaboración de piezas audiovisuales de validación y comunicación del producto, así como la re-priorización del backlog en función de la evidencia recolectada, evidencian una consideración consciente del impacto económico, social y de mercado de las decisiones tomadas por el equipo. |
